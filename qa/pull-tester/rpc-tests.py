...
#Set env vars
if "REALID" not in os.environ:
    os.environ["REALID"] = BUILDDIR + '/src/realichaind' + EXEEXT
if "REALICLI" not in os.environ:
    os.environ["REALICLI"] = BUILDDIR + '/src/realichain-cli' + EXEEXT
