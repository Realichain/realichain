# Bootstrappable Realichain Core Builds

This directory contains the files necessary to perform bootstrappable Realichain
Core builds.
...
To build Realichain Core reproducibly with all default options, invoke the
...
2. The `guix-codesign` command ***requires*** a `DETACHED_SIGS_REPO` flag.
    * _**DETACHED_SIGS_REPO**_
      ...
      Realichain Core version being built.
