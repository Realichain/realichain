...
The instructions below describe how to manually build Realichain with system level or
...
Note
---------------------
Always use absolute paths to configure and compile Realichain and the dependencies,
...
This will build realichain-qt as well if the dependencies are met.
...
If you want to build Realichain-Qt, make sure that the required packages for Qt development
are installed.
...
Once these are installed, they will be found by configure and a realichain-qt executable will be
built by default.
...
Notes
-----
The release is built with GCC and then "strip realichaind" to strip the debug
...
Security
--------
To help make your Realichain installation more secure by making certain attacks impossible to
...
* Non-executable Stack
    ...
    vulnerable buffers are found. By default, Realichain should be built with a non-executable stack
