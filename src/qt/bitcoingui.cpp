...
void BitcoinGUI::createActions()
{
	...
	sendCoinsAction->setStatusTip(tr("Send coins to a Realichain address"));
	...
	receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and realichain: URIs)"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Realichain addresses to prove you own them"));
    verifyMessageAction = new QAction(tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Realichain addresses"));
    ...
    openAction->setStatusTip(tr("Open a realichain: URI or payment request"));

    showHelpMessageAction = new QAction(tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the %1 help message to get a list with possible Realichain command-line options").arg(tr(PACKAGE_NAME)));
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        tooltip = tr("%n active connection(s) to Realichain network", "", count) + QString(".<br>") + tr("Click to disable network activity.");
    } else {
...
{
    QString strTitle = tr("Realichain"); // default title
        ...
        if (key == "tag_name" && !fNewSoftwareFound) {
            ...
            if (fNewSoftwareFound) {
                ...
                if (GetRandInt(3) == 1) {
                    ...
                    if (fRet) {
                        QString link = "https://github.com/realichain/realichain/releases";
...
{
    QDesktopServices::openUrl(QUrl("https://github.com/realichain/realichain/releases", QUrl::TolerantMode));
}

void BitcoinGUI::getLatestVersion()
{
    networkVersionManager->get(QNetworkRequest(QUrl("https://api.github.com/repos/realichain/realichain/releases")));
}
