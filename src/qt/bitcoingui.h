...
public:
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a Realichain wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
...
public Q_SLOTS:
    ...
    /** Switch directly to Realichain history tab */
