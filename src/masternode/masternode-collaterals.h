/*
 * Copyright (c) 2023 The Realichain developers
...
#ifndef REALI_MASTERNODE_COLLATERALS_H_
#define REALI_MASTERNODE_COLLATERALS_H_
...
#endif /* REALI_MASTERNODE_COLLATERALS_H_ */
