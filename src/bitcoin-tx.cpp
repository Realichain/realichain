...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s realichain-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  realichain-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded Realichain transaction") + "\n" +
              "  realichain-tx [options] -create [commands]   " + _("Create hex-encoded Realichain transaction") + "\n" +
              "\n";
