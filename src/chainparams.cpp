...
public:
    CMainParams() {
        ...
        consensus.stage2DevelopmentFundAddress = "RPJrSvCunykMM66TKzkjri7eypa1iZwJbn";

        consensus.stage3StartTime = 1723990638; // Tunday 18 August 2024 14:17:18
        consensus.stage3StartBlock = 61;
        consensus.stage3DevelopmentFundShare = 8;
        consensus.stage3CommunityFundShare = 33;
        consensus.stage3MasternodeShare = 37;
        ...
        std::vector<FundRewardStructure> rewardStructuresProjectExpenses = { {INT_MAX,2} }; // 2% project expenses fee forever    
        consensus.nDevelopmentFundPayment = FundPayment(rewardStructuresDev, 1, "RPJrSvCunykMM66TKzkjri7eypa1iZwJbn"); //Start at block 1
        consensus.nCommunityFundPayment = FundPayment(rewardStructuresCommunity, 1,"RL4GyTizZkC7kXEuBC6HysVXJ5BHfxyj7o");
        consensus.nProjectExpensesFundPayment = FundPayment(rewardStructuresProjectExpenses, 1,"RX4nzgTpqwqQeWtn1N6EdTGHw2znEZ22Ya");
    
       consensus.nCollaterals = CMasternodeCollaterals(
          { {259200, 1000 * COIN}, // Block 0 - 259199 Collateral 1000
            {500000, 3000 * COIN}, // Block 259200 - 499999 Collateral 3000
            {750000, 5000 * COIN}, // Block 500000 - 749999 Collateral 5000
            {999999, 7000 * COIN}, // Block 750000 - 999998 Collateral 8000
            {INT_MAX, 12000 * COIN} // Block 999999 - Infinity Collateral 12000
          },
          { {INT_MAX, 37} } //37% to MNs
        );    
        ...
        consensus.nChainStartTime = 1723990638;
        ...
        consensus.vDeployments[Consensus::DEPLOYMENT_TESTDUMMY].nStartTime = 1723990638; // January 1, 2008
        consensus.vDeployments[Consensus::DEPLOYMENT_TESTDUMMY].nTimeout = 1723991638; // December 31, 2008

        // Deployment of BIP68, BIP112, and BIP113.
        consensus.vDeployments[Consensus::DEPLOYMENT_CSV].bit = 0;
        consensus.vDeployments[Consensus::DEPLOYMENT_CSV].nStartTime = 1723990638; // May 1st, 2016
        consensus.vDeployments[Consensus::DEPLOYMENT_CSV].nTimeout = 1723991638; // May 1st, 2017

        // Deployment of SegWit (BIP141, BIP143, and BIP147)
        consensus.vDeployments[Consensus::DEPLOYMENT_SEGWIT].bit = 1;
        consensus.vDeployments[Consensus::DEPLOYMENT_SEGWIT].nStartTime = 1723990638; // November 15th, 2016.
        consensus.vDeployments[Consensus::DEPLOYMENT_SEGWIT].nTimeout = 1723991638; // November 15th, 2017.
        ...
        consensus.nLLMQPowTargetSpacing = 4*60;
        ...
        //btzc: update realichain pchMessage
        ...
        vSeeds.push_back(CDNSSeedData("37.60.227.86", "37.60.227.86", false));
        vSeeds.push_back(CDNSSeedData("217.76.62.130", "217.76.62.130", false));
        ...
        consensus.evoSporkKeyID = "RSoMrNtZqoGCcEsqkaT4ofe9w6T4dSeCpz";
        ...
        // ProgPow
        consensus.nPPSwitchTime = 1723999638;           // Tue Oct 26 2021 06:00:00 GMT+0000
...
public:
    CTestNetParams() {
        ...
        std::vector<FundRewardStructure> rewardStructuresProjectExpenses = { { INT_MAX, 8} }; // 8% data mining fee forever
        ...
        consensus.nProjectExpensesFundPayment = FundPayment(rewardStructuresProjectExpenses, 250,"TCkC4uoErEyCB4MK3d6ouyJELoXnuyqe9L");
        consensus.nCollaterals = CMasternodeCollaterals(
          { {250, 50 * COIN},
            {450, 150 * COIN},
            {650, 250 * COIN},
       ...
       extraNonce[0] = 0x09;
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        // realichain test seeds

        vSeeds.push_back(CDNSSeedData("EVO1", "evo1.realichain.org", false));
        vSeeds.push_back(CDNSSeedData("EVO2", "evo2.realichain.org", false));
...
public:
    CDevNetParams() {
        ...
        consensus.nProjectExpensesFundPayment = FundPayment(rewardStructuresProjectExpenses, 200,"TZpbhfvQE61USHsxd55XdPpWBqu3SXB1EP");
        consensus.nCollaterals = CMasternodeCollaterals(
          { {200, 1000 * COIN},
            {INT_MAX, 5000 * COIN}
          },
        ...
        vSeeds.push_back(CDNSSeedData("DEVNET1", "devnet1.realichain.org", false));
        vSeeds.push_back(CDNSSeedData("DEVNET2", "devnet2.realichain.org", false));
