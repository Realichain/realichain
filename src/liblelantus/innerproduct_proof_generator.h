#ifndef REALI_LIBLELANTUS_INNERP_RODUCT_PROOF_GENERATOR_H
#define REALI_LIBLELANTUS_INNERP_RODUCT_PROOF_GENERATOR_H
...
#endif //REALI_LIBLELANTUS_INNERP_RODUCT_PROOF_GENERATOR_H
