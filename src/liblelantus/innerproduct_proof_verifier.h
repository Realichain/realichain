#ifndef REALI_LIBLELANTUS_INNER_PRODUCT_PROOF_VERIFIER_H
#define REALI_LIBLELANTUS_INNER_PRODUCT_PROOF_VERIFIER_H
...
#endif //REALI_LIBLELANTUS_INNER_PRODUCT_PROOF_VERIFIER_H
