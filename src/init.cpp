...
void Shutdown()
{
    ...
    RenameThread("realichain-shutoff");
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/Realichain/realichain>";
    const std::string URL_WEBSITE = "<https://realichain.org/>";
...
void ThreadImport(std::vector <boost::filesystem::path> vImportFiles) {
    ...
    RenameThread("realichain-loadblk");
...
void InitLogging() {
    ...
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf("Realichain version %s\n", FormatFullVersion());
}
