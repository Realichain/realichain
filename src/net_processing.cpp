...
bool static AlreadyHave(const CInv& inv) EXCLUSIVE_LOCKS_REQUIRED(cs_main)
{
    ...
    case MSG_DANDELION_WITNESS_TX:
        ...
        /*
            Realichain Related Inventory Messages
...
bool static ProcessMessage(CNode* pfrom, const std::string& strCommand, CDataStream& vRecv, int64_t nTimeReceived, const CChainParams& chainparams, CConnman& connman, const std::atomic<bool>& interruptMsgProc)
{
    ...
    else if (strCommand == NetMsgType::VERSION)
    {
        ...
        if (!vRecv.empty()) {
            ...
            if (sscanf(cleanSubVer.c_str(), "/Realichain:%2d.%2d.%2d.%2d/",
                ...
                if (peerClientVersion < MIN_REALI_CLIENT_VERSION) {
                    LogPrintf("peerClientVersion: %d CLIENT_VERSION: %d MIN_REALI_CLIENT_VERSION: %d\n", peerClientVersion,CLIENT_VERSION, MIN_REALI_CLIENT_VERSION);
