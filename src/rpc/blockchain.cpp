...
static bool GetUTXOStats(CCoinsView *view, CCoinsStats &stats)
{
    ...
    stats.nTotalAmount -= 16810168037691; // Total burnt Coins sent to unrecoverable address https://explorer.realichain.org/tx/0b53178c1b22bae4c04ef943ee6d6d30f2483327fe9beb54952951592e8ce368
...
UniValue gettxout(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() < 2 || request.params.size() > 3)
        throw std::runtime_error(
            ...
            "     \"addresses\" : [          (array of string) array of Realichain addresses\n"
            "        \"realichainaddress\"     (string) Realichain address\n"
            "        ,...\n"
            "     ]\n"
            "  },\n"
