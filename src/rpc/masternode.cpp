...
void masternode_list_help()
{
    throw std::runtime_error(
            ...
            "  owneraddress   - Print the znode owner Realichain address\n"
            "  payee          - Print the znode payout Realichain address (can be additionally filtered,\n"
            "                   partial match)\n"
            "  pubKeyOperator - Print the znode operator public key\n"
            "  status         - Print znode status: ENABLED / POSE_BANNED\n"
            "                   (can be additionally filtered, partial match)\n"
            "  votingaddress  - Print the znode voting Realichain address\n"
        );
}
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    { "realichain",               "znode",                 &masternode,             true,  {} },
    { "realichain",               "znodelist",             &masternodelist,         true,  {} },
    { "realichain",               "evoznode",              &masternode,             true,  {} },
    { "realichain",               "evoznodelist",          &masternodelist,         true,  {} },
};
