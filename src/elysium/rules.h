#ifndef REALI_ELYSIUM_RULES_H
#define REALI_ELYSIUM_RULES_H
...
public:
    ...
    /**
     * Amount of REALI to pay when create a new property on main ecosystem.
     **/
